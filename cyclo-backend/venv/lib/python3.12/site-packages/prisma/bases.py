...
class BaseProjectApplication(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ProjectApplication']] = 'ProjectApplication'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ProjectApplicationActions[_PrismaModelT]':
        from .client import get_client

        return actions.ProjectApplicationActions[_PrismaModelT](client or get_client(), cls)
